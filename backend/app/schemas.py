...
class TodoCreate(BaseModel):
    ...
    title: str = Field(..., min_length=1, max_length=255, description="Title of the todo item")
    description: str | None = Field(None, max_length=2000, description="Optional detailed description")
    completed: bool | None = Field(default=False, description="Initial completion status")
